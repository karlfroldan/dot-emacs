...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smart-mode-line-powerline-theme smart-mode-line org-fragtog lua-mode minimap linum-relative centaur-tabs solo-jazz-theme flucui-themes julia-mode magit modus-themes material-theme darcula-theme xcscope scheme-complete all-the-icons-ivy frog-jump-buffer projectile geiser-guile geiser-chicken geiser ghci-completion yaml-mode auctex lsp-haskell company lsp-mode zig-mode vterm-toggle use-package vterm haskell-mode cmake-mode)))
(custom-set-faces
